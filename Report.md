...
Here we read the first line of the csv file, extract lat0 and lon0 as floating point values and use the self.global_home
() method to set global home. Explain briefly how you accomplished this in your code.
...
Here as long as we successfully determine our local position relative to global home we'll be all set. We use global_to_local fuction to get the local imformation
...
I add diaggonal motion into Class Action, and also put them into fuction valid_actions to take them into motion planning
...
I write a function called purne_path to make the path become easier and clear, just compare whether the middle point is necessary
